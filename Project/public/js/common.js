...
function showMessage(time, text, url) {
    ...
    div_html += '<img src="/cn/cart/pc/images/information.png" />&nbsp;&nbsp;';
...
function opencover(title, tips, method) {
    ...
    pc_coverhtml += '            <a onclick="closecover()" class="closebtn" id="closebtn" style="cursor:pointer"><img src="'+imgUrl+'/images/close.png"/></a>';    
    pc_coverhtml += '        </div>';
    pc_coverhtml += '        <div class="box_btm">';
    pc_coverhtml += '            <img src="'+imgUrl+'/images/warn.png" />';
