...
<!-- 收货地址 -->
            ...
            <!-- 收货地址表单开始 -->
            <form action="/home/myaddress/{{ $ob->Address_id }}" method="post">
                {{ csrf_field() }}
                {{ method_field('PUT') }}
            <div class='aa' style="border:1 solid #fff;width:650px;margin-left:250px;">
                <ul class="layer_ul" style="margin-top:80px;padding: 0 16px;font-size: 13px;">
                    <li class="clearfix" style="height: 24px;line-height: 24px;padding-top: 17px;">
                        ...
                        <input type="text" id="name" style="float: left;height: 22px;line-height: 22px;width: 147px;padding: 0 5px;border: 1px solid #d2d2d2;font-size: 13px;" name="Address_consignee" value="{{ $ob->Address_consignee }}">
                    </li>
                    <li class="clearfix" style="height: 24px;line-height: 24px;padding-top: 17px;">
                        ...
                        <input type="text" id="mobile"style="float: left;height: 22px;line-height: 22px;width: 147px;padding: 0 5px;border: 1px solid #d2d2d2;font-size: 13px;"name="Address_consignee_phone" value="{{ $ob->Address_consignee_phone }}"/>
                    </li>              
                    <li class="detail_address clearfix" style="height: 24px;line-height: 24px;padding-top: 17px;">
                        ...
                        <input type="text" id="goodsStreet" maxlength="25" style="width: 404px;float: left;height: 22px;line-height: 22px;padding: 0 5px;border: 1px solid #d2d2d2;font-size: 13px;" name="Address_detail" value="{{ $ob->Address_detail }}"/>
                    </li>
                        <li class="clearfix" style="height: 24px;line-height: 24px;padding-top: 17px;">
                        ...
                        <input type="text" id="mail" style="float: left;height: 22px;line-height: 22px;width: 147px;padding: 0 5px;border: 1px solid #d2d2d2;font-size: 13px;" name="Address_email" value="{{ $ob->Address_email }}"/>
                    </li>
