...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body id="skin-blur-violate">
        ...
        <section id="login">
            ...
            <!-- Login -->
            <form class="box tile animated active" id="box-login" action='/backstage/dologin' method='post'>
                {{ csrf_field() }}
                @if(session('msg'))
                ...
                <input type="text" class="login-control m-b-10" placeholder="Username or Email Address" name='Admin_name'>
                <input type="password" class="login-control" placeholder="Password" name='Admin_pass'>
                <h4 class="m-t-0 m-b-15">Enter Captcha</h4>
                <div class='row'>
                    <div class='col-xs-4'>
                        <img src="{{ url('/backstage/captch/'.time()) }}" onclick="this.src='{{ url('/backstage/captch') }}/'+Math.random()" />
                    </div>
                    <div class='col-xs-4'>
                        <input type='text' class='login-control m-b-10' placeholder="Captcha" name='mycode'>
                    </div>
                </div>
                ...
                <small>
                    <a class="box-switcher" data-switch="box-register" href="/backstage/register">Don't have an Account?</a> or
                    <a class="box-switcher" data-switch="box-reset" href="">Forgot Password?</a>
                </small>
            </form>
            <!-- Register -->
            <form class="box animated tile" id="box-register" action="/backstage/doregister" method="post">
                {{ csrf_field() }}
